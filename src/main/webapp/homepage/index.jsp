...
<table style="border:2px; background-color:#f9dede; solid: #8A0000;margin-bottom:10px;" align="center" width="80%">
    ...
    <td style="padding:8px;">
        <table align="center">
            <tr>
                <td ><span style="font-size:14px;color:#8A0000;">&nbsp;The 21st annual meeting of the Complex Trait Community will be hosted at the Medical College of Wisconsin October 2-5, 2024.</span> (<a href="https://rgd.mcw.edu/wg/ctc-rg2024/">View Agenda</a>)</td>
            </tr>
        </table>
    </td>
    </tr>
