...
<div style="background-color:#fff3cd; border:1px solid #ffc107; color:#856404; padding:12px 20px; margin:10px auto; max-width:80%; text-align:center; border-radius:6px; font-size:15px;">
    <b>Scheduled Maintenance:</b> RGD will be undergoing maintenance between 11:00 AM and 11:30 PM (CT) on Tuesday, July 7th. Some services may be temporarily unavailable during this time.
</div>
