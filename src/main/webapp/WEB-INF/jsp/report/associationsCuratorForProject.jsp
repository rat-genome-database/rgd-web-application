...
<%
    ...
    List<Annotation> annotList = annotationDAO.getAnnotationsForProject(obj.getRgdId());
    ...
    boolean hasPhenoMinerAnn = (annotationDAO.getPhenoAnnotationsCountByReferenceForProject(obj.getRgdId())>0);
...
<div class="light-table-border">
    <div class="sectionHeading" id="experimentalDataAnnotationsCurator">Experimental Data Annotations 1&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="associationsToggle" onclick="toggleAssociations('experimentalDataAnnotationsCurator', 'experimentalDataAnnotations');">Click to see Annotation Detail View</a></div>
