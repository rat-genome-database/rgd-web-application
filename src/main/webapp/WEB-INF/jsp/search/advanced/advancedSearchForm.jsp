...
<%--    comments--%>
    ...
    <tr><td>
        <table border='0' >
            ...
            <tr>
                <td colspan="6" ><b>Keyword</b> <input name="term" id="objectSearchTerm" type="text" value="" size="85"/>&nbsp;&nbsp;</td>
            </tr>
            <tr><td colspan=3>&nbsp;</td></tr>
            <tr>
                        <%
...
<%--            <tr><td style="border: 1px solid black;">--%>
            ...
            <tr><td colspan=3>&nbsp;</td></tr>
            <tr>
                <td colspan="4" align="center"><input type="submit" value="Search <%=title%>" /></td>
            </tr>
        </table>
    </td></tr>
    <% } %>
