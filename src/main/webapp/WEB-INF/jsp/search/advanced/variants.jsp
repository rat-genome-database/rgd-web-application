...
<div class="searchBox">
  ...
  <div class="searchExamples">
    <b>Example searches:</b> <a href="javascript:document.adSearch.term.value='A2m';document.adSearch.chr.value='0';document.adSearch.submit();" >A2m</a>,<a href="javascript:document.adSearch.term.value='leptin';document.adSearch.chr.value='0';document.adSearch.submit();" >leptin</a>,<a href="javascript:document.adSearch.term.value='lepr';document.adSearch.chr.value='0';document.adSearch.submit();" >lepr</a>, <a href="javascript:document.adSearch.term.value='leprot';document.adSearch.chr.value='0';document.adSearch.submit();" >leprot</a>, <a href="javascript:document.adSearch.term.value='Adora2a';document.adSearch.chr.value='0';document.adSearch.submit();" >Adora2a</a>
  </div>
  <br>
