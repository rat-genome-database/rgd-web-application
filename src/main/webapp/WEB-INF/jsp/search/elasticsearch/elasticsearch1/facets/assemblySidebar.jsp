...
<%
    ...
    Map<String, List<? extends EsBucket>> aggregations =
            (Map<String, List<? extends EsBucket>>) model.get("aggregations");
    ...
    <div id="jstree_results">
        <ul>
            ...
            <% } else if(categoryLC.equals("strain")) {
                List<? extends EsBucket> bkts = aggregations.get(strainKey);
                if(bkts != null && !bkts.isEmpty()) { %>
            ...
            <% } else if(categoryLC.equals("qtl")) {
                List<? extends EsBucket> bkts = aggregations.get(qtlKey);
                if(bkts != null && !bkts.isEmpty()) { %>
            ...
            <% } else if(categoryLC.equals("sslp")) {
                List<? extends EsBucket> bkts = aggregations.get(sslpKey);
                if(bkts != null && !bkts.isEmpty()) { %>
            ...
            <% } else if(categoryLC.equals("cell line")) {
                List<? extends EsBucket> bkts = aggregations.get(cellLineKey);
                if(bkts != null && !bkts.isEmpty()) { %>
            ...
            <% } else if(categoryLC.equals("promoter")) {
                List<? extends EsBucket> bkts = aggregations.get(promoterKey);
                if(bkts != null && !bkts.isEmpty()) { %>
            ...
            <% } else {
                ...
                for(String[] grp : genericGroups) {
                    String label = grp[0];
                    String aggKey = grp[1];
                    List<? extends EsBucket> bkts = aggregations.get(aggKey);
