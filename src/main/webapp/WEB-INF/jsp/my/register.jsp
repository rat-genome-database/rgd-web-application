...
<form action="/rgdweb/register" method="POST" >
    <table align="center" style="border:2px outset lightgrey;background-color:#F7F7F7;padding:40px;">
        <tr>
        ...
        <tr><td>Enter Password:</td><td><input type='password' name='pass1' value=""></td></tr>
        ...
        <tr>
            <td  align="right"><input name="submit"  onClick="location.href='/rgdweb'" type="button" value="Cancel" style="font-size:16px; margin-top:20px;"></td>
            <td  align="left"><input name="submit" type="submit" value="Log In" style="font-size:16px; margin-top:20px;"></td>
        </tr>
        <tr>
        </tr>
    </table>
