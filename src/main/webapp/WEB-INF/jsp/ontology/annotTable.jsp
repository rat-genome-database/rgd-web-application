...
<%
    ...
    if (tws.getStat("annotated_object_count", bean.getSpeciesTypeKey(), bean.getObjectKey(), withKids) > 10000) { %>
...
<div style="padding:30px; border: 3px solid #FFCF3E; font-size:20px;">
    ...
    The maximum number of objects that can be shown is 10,000.
