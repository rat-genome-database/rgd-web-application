...
<table align="center" border="0">
    <tr>
        <td align="center"><input  style="font-size:30px" type="button" onclick="location.href='/jbrowse2/'" value="Select JBrowse 2"/></td>
        <td></td>
        <td align="center"><input style="font-size:30px" onclick="location.href='/jbrowse/'" type="button" value="Select JBrowse 1"/></td>
    </tr>
    <tr>
        <td valign="top">
