...
jQuery_1_3_2(document).ready(function(){
    ...
    jQuery_1_3_2("input[name='rdo_term']").autocomplete('https://ontomate.rgd.mcw.edu/OntoSolr/select', {
      extraParams:{
   ...
   jQuery_1_3_2("#mp_popup").click(function(){
    ...
    jQuery_1_3_2("input[name='mp_term']").autocomplete('https://ontomate.rgd.mcw.edu/OntoSolr/select', {
      extraParams:{
          'qf': 'term_en^5 term_str^3 term^3 synonym_en^4.5 synonym_str^2 synonym^2 def^1 anc^1',
          'bf': 'term_len_l^.02',
    ...
    jQuery_1_3_2("#pw_popup").click(function(){
     ...
     jQuery_1_3_2("input[name='pw_term']").autocomplete('https://ontomate.rgd.mcw.edu/OntoSolr/select', {
       extraParams:{
           'qf': 'term_en^5 term_str^3 term^3 synonym_en^4.5 synonym_str^2 synonym^2 def^1 anc^1',
           'bf': 'term_len_l^.02',
    ...
    jQuery_1_3_2("input[name='chebi_term']").autocomplete('https://ontomate.rgd.mcw.edu/OntoSolr/select', {
      extraParams:{
          'qf': 'term_en^5 term_str^3 term^3 synonym_en^4.5 synonym_str^2 synonym^2 def^1 anc^1',
          'bf': 'term_len_l^.02',
