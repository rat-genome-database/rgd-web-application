...
public abstract class EditObjectController implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {        
        ...
        if(!checkToken(accessToken))
            response.sendRedirect("https://github.com/login/oauth/authorize?client_id=7de10c5ae2c3e3825007&scope=user&redirect_uri=http://localhost:8080/rgdweb/curation/login.html");
        if(geneType!=null)
