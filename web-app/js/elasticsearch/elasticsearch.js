...
function toolSubmit(_this, species,tool, objectType, mKey, $assembly) {
    ...
    if(selected!=""){
        ...
        if(tool=='olga') {
            if(selectedSymbols!=""){
                href="/rgdweb/generator/list.html?mapKey="+ mapKey+"&oKey="+objectkey+"&vv=&ga=&act=&a="+"~lst:" + selectedSymbols.replace(/\,/g, '[');
            }/*else {
        ...
        if(tool=='vv') {
            if (objectType == 'variants') {
                ...
                href="variantVisualizer.html?&species="+species +"&assembly="+$assembly +"&mapKey="+mapKey +"&geneList=" +selectedSymbols;
