...
function filterClick(category, species,subCat, type, filter) {
    ...
    var moet="<p><div class=\"tooltips\"><a onclick=\"toolSubmit(this,$('#species').val(),'moet', \'"+objectType+"\',$('#mapKey').val())\"  style=\"cursor: pointer\"><img  class=\"boxedTools toolicon\" src=\"/rgdweb/common/images/damaging_small.png\"></a><span class=\"tooltiptext\" style=\"font-size: x-small\">Send your list of genes to multi ontology enrichment tool.</span>&nbsp;<a onclick=\"toolSubmit(this,$('#species').val(),'moet', \'"+objectType+"\',$('#mapKey').val())\" target=\"_blank\" style=\"cursor: pointer; font-size: 11px\">MOET</a></div></p>";
