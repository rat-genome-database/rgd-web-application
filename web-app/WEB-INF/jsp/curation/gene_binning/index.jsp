    ...
    <div class="show_bins">
        <button>
            <c:if test="${model.pepDetail.getTotalGenes() > 15}">
                <a style="text-decoration: none" href="/rgdweb/curation/geneBinning/bins.html?termAcc=GO:0008233&term=peptidase activity&parent=0&childTermAcc=GO:0070001&childTerm=aspartic-type peptidase activity">
                    Show Gene Bins
                </a>
            </c:if>
            <c:if test="${model.pepDetail.getTotalGenes() <= 15}">
                <a style="text-decoration: none" href="/rgdweb/curation/geneBinning/bins.html?termAcc=GO:0008233&term=peptidase activity&parent=1">
                    Show Gene Bins
                </a>
            </c:if>
        </button>
