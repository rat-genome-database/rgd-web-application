...
<span class="phenominerPageHeader">PGA Load - Genders</span>
...
<div class="pga_main">
    ...
    <%  for( Map.Entry<String, String> entry: bean.getMapGender().entrySet() ) { %>
        <tr>
            <td><%=entry.getKey()%></td>
    ...
    <%}%>
        <tr>
            <th colspan="2">
                <input type="submit" value="Proceed to RAT DIETS">
