...
<%@ page import="edu.mcw.rgd.carpenovo.SNPlotyper" %>
...
<%@ page import="edu.mcw.rgd.carpenovo.dao.VariantSearchBeanNew" %>
...
<%
   ...
   SNPlotyper snplotyper = (SNPlotyper) request.getAttribute("snplotyper");
    VariantSearchBeanNew vsb = (VariantSearchBeanNew) request.getAttribute("vsb");
