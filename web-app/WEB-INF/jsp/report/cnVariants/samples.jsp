...
<div class="reportTable light-table-border" id="variantSamplesTableWrapper">
    ...
    <div id="variantSamplesTableDiv" class="annotation-detail">
        ...
        <%
            ...
            <td><a href="javascript:void(0);" onMouseOut="document.getElementById('div_<%=s.getId()%>').style.visibility='hidden';" onMouseOver="document.getElementById('div_<%=s.getId()%>').style.visibility='visible';"><%=s.getAnalysisName()%></a>
