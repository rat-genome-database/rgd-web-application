...
<div class="reportTable light-table-border" id="variantSamplesTableWrapper">
    <div class="sectionHeading" id="variantSamples">Variants</div>
    <br>
    <div>
        <b><a style="font-size: 14px;" href="/rgdweb/report/rsId/main.html?geneId=<%=rgdId.getRgdId()%>">View list of variants within Object</a></b>
    </div>
    </div>
</div>
