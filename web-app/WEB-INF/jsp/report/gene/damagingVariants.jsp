       ...
       String pstrain = "",passembly = "";
        ...
        for (Variant v : assembly) {
            ...
            if(v1.getStartPos() == v.getStartPos() && v1.getEndPos() == v.getEndPos()
                ...
                String url = "/rgdweb/front/variants.html?chr=&start=&stop=&geneStart=&geneStop=&mapKey="+m.getKey()+"&geneList="+obj.getSymbol()+"&con=&probably=true&possibly=true=&depthLowBound=&depthHighBound=&sample1="+s.getId();
