...
<div id="searchResultHeader" style="border-bottom: 3px solid gray;">
    <ul>
        <li <%=viewNr.equals("1")?"id=selected":""%>><a onclick="removeHashLink()" href="javascript:addParam('view',1)">General</a></li>
        ...
        -->
        <li <%=viewNr.equals("4")?"id=selected":""%>><a onclick="removeHashLink()" href="javascript:addParam('view',4)">Array IDs</a></li>
        <!--
        -->
