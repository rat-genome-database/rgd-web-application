...
<%
    List<Gene> relatedGenes = associationDAO.getAssociatedGenesForMasterRgdId(obj.getRgdId(), "cellline_to_gene", null);
...
<%
    List<Gene> relatedGenes = associationDAO.getAssociatedGenesForMasterRgdId(obj.getRgdId(), "cell_line_to_gene", null);
