...
<tr>
    <td colspan="6" ><b>Keyword</b> <input name="term" type="text" value="" id="objectSearchTerm" size="50"/><input type="submit" value="Search <%=title%>" />&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
    <td>
        <%
...
$(document).ready(function(){
    ...
    $("input[name='rs_term']").autocomplete('/OntoSolr/select', {
      extraParams:{
    ...
    $("input[name='vt_term']").autocomplete('/OntoSolr/select', {
      extraParams:{
          'qf': 'term_en^5 term_str^3 term^3 synonym_en^4.5 synonym_str^2 synonym^2 def^1 anc^1',
          'bf': 'term_len_l^.02',
