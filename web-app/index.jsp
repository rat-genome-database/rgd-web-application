...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="row">
          <div class="col-sm-8"  style="background-color: #EFF3FC;margin-bottom:10px">
              <div class="jumbotron"  style="background-color: #EFF3FC;">

                      <div class="row" >
                         <p style="color:darkslategrey"><span style="font-weight: bold;font-size: 14px;color:#24609c">The Rat Genome Database</span> (RGD) was established in 1999 and is the premier site for genetic, genomic, phenotype, and disease data generated from rat research. In addition, it provides easy access to corresponding human and mouse data for cross-species comparisons. RGD's comprehensive data and innovative software tools make it a valuable resource for researchers worldwide.</p>
                       </div>
                      <div class="row">
                      ...
                      <div class="card col" style="width: 18rem;height:100px">
                          <a href="https://rgd.mcw.edu/wg/chinchilla/">
                              <div>
                      ...
                      <div class="card col" style="width: 18rem;height:100px">
                          ...
                          <div class="card col" style="width: 18rem;height:100px">
                              <p style="font-weight: bold;color: #24609c;">Pig</p>
                              <img src="/rgdweb/common/images/species/bonobo.jpg" height="50%"  border="0" />
                          </div>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-8" >
                <div class="card row" style="border-color: transparent;background-color:#EFF3FC">
                    <h5 style="font-size: medium;padding:5px 0 0 5px" class="card-title">Popular tools</h5>

                </div>
                <br>
                <div class="row" style="margin-bottom: 2%;height:20%">
                    <div class="card col"  style="width: 18rem;;margin-right: 2%;">

                        <p style="font-weight: bold;color: #24609c;font-size: 14px;text-align: center;padding-top:1%">Multi Ontology Enrichment</p>
                        <span style="text-align: center"><img src="/rgdweb/images/MOET.png" height="70%" width="70%" border="0" /></span>

                    </div>
                    <div class="card col"  style="width: 18rem;;margin-right: 2%;;text-align: center;padding-top:1%;" >
                        <p style="font-weight: bold;color: #24609c;font-size: 14px">Pathways</p>
                        <span style="text-align: center"><img src="/rgdweb/images/pathway.png" height="70%" width="70%" border="0" /></span>
                    </div>

                    <div class="card col" style="width: 18rem;;text-align: center;padding-top:1%">
                        <p style="font-weight: bold;color: #24609c;font-size: 14px">Phenotype Ranges</p>
                        <span style="text-align: center"><img src="/rgdweb/images/expectedRanges.png"  height="70%" width="70%" border="0" /></span>
                    </div>
                </div>
                <div class="row"  style="margin-bottom: 2%;height:20%">
                    <div class="card col" style="width: 18rem;margin-right: 2%;text-align: center;padding-top:1%">
                        <p style="font-weight: bold;color: #24609c;font-size: 14px">Disease Navigator</p>
                        <span style="text-align: center"><img src="/rgdweb/common/images/diseaseNavLogo75.png" height="70%"  width="70%" border="0" /></span>
                    </div>
                    <div class="card col" style="width: 18rem;;margin-right: 2%;text-align: center;padding-top:1%">
                        <p style="font-weight: bold;color: #24609c;font-size: 14px">Protein-Protein Interactions</p>
                        <span style="text-align: center"><img src="/rgdweb/images/cy_new.png" height="70%" width="70%" border="0" /></span>
                    </div>
                    <div class="card col" style="width: 18rem;;text-align: center;padding-top:1%">
                ...
                <div class="row" style="height:20%">
                    <div class="card col" style="width: 18rem;height:auto;margin-right: 2%;text-align: center;padding-top:1%">
                        <p style="font-weight: bold;color: #24609c;font-size: 14px">Variant Visualizer</p>
                        <span style="text-align: center"><img src="/rgdweb/common/images/variantVisualizer.png"  height="70%" width="70%" border="0" /></span>
                    </div>
                    <div class="card col" style="width: 18rem;height:auto;margin-right: 2%;text-align: center;padding-top:1%">
                        <p style="font-weight: bold;color: #24609c;font-size: 14px">PhenoMiner</p>
                        <span style="text-align: center"><img src="/rgdweb/common/images/phenominerNew.png"  height="70%" width="70%" border="0" /></span>
                    </div>
                    <div class="card col" style="width: 18rem;height:auto;;text-align: center;padding-top:1%">
                        <p style="font-weight: bold;color: #24609c;font-size: 14px">OntoMate - Literature Search</p>
                        <span style="text-align: center"><img src="/rgdweb/images/logo.png" height="70%" width="50%" border="0" /></span>
                    </div>
                </div>
                <br>
            ...
            <div class="col-sm-4" >
                <div class="card" style="border-color: transparent;">
                    ...
                    <h5 style="font-size: medium;padding:5px 0 0 5px" class="card-title">Popular Searches</h5>
                    </div>
                    <br>
                    <div>
                        <p style="font-weight: bold;color: #24609c;font-size: 12px"><img src="/rgdweb/common/images/searchGlass.png" height="20px" width="10%"  border="0" />&nbsp;Genes  </p>



                        <p style="font-weight: bold;color: #24609c;font-size: 12px"><img src="/rgdweb/common/images/searchGlass.png" height="20px" width="10%"  border="0" />&nbsp;Strains</p>



                        <p style="font-weight: bold;color: #24609c;font-size: 12px"><img src="/rgdweb/common/images/searchGlass.png" height="20px" width="10%"  border="0" />&nbsp;QTLs</p>



                        <p style="font-weight: bold;color: #24609c;font-size: 12px"><img src="/rgdweb/common/images/searchGlass.png" height="20px" width="10%"  border="0" />&nbsp;Ontologies</p>
                    </div>
                ...
                <div class="card" style="border-color: transparent;">
                    ...
                    <div>
                        ...
                        <p><a href="https://rgd.mcw.edu/wg/portals/" style="font-weight: bold;color: #24609c;font-size: 12px"><img src="/rgdweb/common/images/diseaseModels.png" width="50px" height="50px"/>&nbsp;Disease Portals</a></p>
        ...
        <div class="" style="border-color: transparent;">
            <div class="" style="border-color: transparent;">
                <h5 class="card-title">Featured RGD Video Tutorials&nbsp;&nbsp;<a title="RGD's Rat Community Videos page" href="https://rgd.mcw.edu/wg/home/rgd_rat_community_videos/" target="_self">More Videos...</a></h5>
            </div>
            <hr>
            <div class="row">
                <div class="col">
