                            ...
                            <tr>
                                <td>
                                    <table >
                                        ...
                                        <tr>
                                            <td class="subHeader" width="300">Allele of Gene</td>
                    ...
                    <td>
                        ...
                        <table width="100%" cellpadding="0" cellspacin="0">
                            ...
                            <tr>
                                ...
                                <td class="subHeader">Chromosome</td>
                                <td class="subHeader">Start</td>
                                <td class="subHeader">Stop</td>
                                <td class="subHeader">Reference<br>Nucleotide</td>
                                <td class="subHeader">Variant<br> Nucleotide</td>
                                ...
                                <tr>
                                    ...
                                    <td class="cell">deletion</td>
                                    <td class="cell">12</td>
                                    <td class="cell">46493042</td>
                                    <td class="cell">46493043</td>
                                    <td class="cell">C</td>
                                    <td class="cell">-</td>
